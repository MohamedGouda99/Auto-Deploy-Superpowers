...
var ValidationExecutor = /** @class */ (function () {
    ...
    ValidationExecutor.prototype.nestedValidations = function (value, metadatas, errors, definedMetadatas, allMetadatas) {
        var _this = this;
        if (value === void 0) {
            return;
        }
        metadatas.forEach(function (metadata) {
            ...
            if (value instanceof Array || value instanceof Set || value instanceof Map) {
                ...
                arrayLikeValue.forEach(function (subValue, index) {
                    _this.performValidations(value, subValue, index.toString(), definedMetadatas, allMetadatas, errors);
                });
            }
